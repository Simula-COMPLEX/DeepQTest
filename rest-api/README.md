## A pedestrian is crossing the road from left to right.
## http://127.0.0.1:5000/deepqtest/lgsvl-api/agents/pedestrian/cross-road?direction=left
## A pedestrian is crossing the road from right to left.
## http://127.0.0.1:5000/deepqtest/lgsvl-api/agents/pedestrian/cross-road?direction=right
## A pink Jeep is driving ahead (far) of the ego vehicle and maintaining lane.
...
## A white BoxTruck is overtaking (far) the ego vehicle and switching lane.
...
## A red BoxTruck is driving ahead (far) of the ego vehicle and switching lane.
...
## A black Jeep is driving ahead (far) of the ego vehicle and switching lane.
...
## A pink Sedan is driving from the opposite direction (far) and switching lane.
...
## A skyblue Jeep is driving from the opposite direction (far) and maintaining lane.
...
## A yellow BoxTruck is overtaking (far) the ego vehicle and maintaining lane.
...
## A red SchoolBus is overtaking (far) the ego vehicle and switching lane.
...
## A yellow SUV is overtaking (far) the ego vehicle and switching lane.
...
## A white Hatchback is driving ahead (far) of the ego vehicle and switching lane.
...
## A white Hatchback is overtaking (far) the ego vehicle and maintaining lane.
...
## A white Jeep is crossing the road (far) and maintaining lane.
## http://127.0.0.1:5000/deepqtest/lgsvl-api/agents/npc-vehicle/cross-road?car=Jeep&color=white&maintainlane=1&position=far
## A red BoxTruck is driving ahead (far) of the ego vehicle and maintaining lane.
...
## A pink Hatchback is driving from the opposite direction (far) and switching lane.
...
## A white SchoolBus is driving ahead (far) of the ego vehicle and maintaining lane.
...
## A white SUV is driving ahead (far) of the ego vehicle and switching lane.
...
## A pink Hatchback is crossing the road (far) and maintaining lane.
...
## A skyblue SUV is crossing the road (far) and maintaining lane.
## http://127.0.0.1:5000/deepqtest/lgsvl-api/agents/npc-vehicle/cross-road?car=SUV&color=skyblue&maintainlane=1&position=far
## A skyblue Hatchback is driving ahead (far) of the ego vehicle and maintaining lane.
...
## A pink SUV is overtaking (far) the ego vehicle and maintaining lane.
...
## A pink Sedan is driving from the opposite direction (far) and maintaining lane.
...
## A white Sedan is driving ahead (far) of the ego vehicle and switching lane.
...
## A black SchoolBus is crossing the road (far) and maintaining lane.
...
## A pink SUV is driving from the opposite direction (far) and maintaining lane.
## http://127.0.0.1:5000/deepqtest/lgsvl-api/agents/npc-vehicle/drive-opposite?car=SUV&color=pink&maintainlane=1&position=far
## A pink SUV is crossing the road (far) and switching lane.
...
## A skyblue Hatchback is driving from the opposite direction (far) and maintaining lane.
...
## A skyblue SchoolBus is driving ahead (far) of the ego vehicle and switching lane.
...
## A black Jeep is overtaking (far) the ego vehicle and maintaining lane.
...
## A black SUV is driving from the opposite direction (far) and switching lane.
...
## A white SchoolBus is driving from the opposite direction (far) and switching lane.
...
## A yellow Hatchback is overtaking (far) the ego vehicle and switching lane.
...
## A yellow SchoolBus is overtaking (far) the ego vehicle and maintaining lane.
...
## A white SchoolBus is crossing the road (far) and switching lane.
...
## A pink SchoolBus is driving from the opposite direction (far) and maintaining lane.
...
## A yellow Sedan is crossing the road (far) and maintaining lane.
## http://127.0.0.1:5000/deepqtest/lgsvl-api/agents/npc-vehicle/cross-road?car=Sedan&color=yellow&maintainlane=1&position=far
## A black Sedan is driving ahead (far) of the ego vehicle and maintaining lane.
...
## A yellow Sedan is overtaking (far) the ego vehicle and maintaining lane.
...
## A skyblue Sedan is overtaking (far) the ego vehicle and switching lane.
...
## A yellow Jeep is driving from the opposite direction (far) and switching lane.
...
## A red BoxTruck is driving from the opposite direction (far) and maintaining lane.
...
## A white BoxTruck is driving from the opposite direction (far) and switching lane.
...
## A red SUV is driving ahead (far) of the ego vehicle and maintaining lane.
...
## A skyblue Jeep is overtaking (far) the ego vehicle and switching lane.
...
## A white Jeep is driving ahead (near) of the ego vehicle and maintaining lane.
...
## A red SUV is overtaking (near) the ego vehicle and maintaining lane.
...
## A red SUV is crossing the road (near) and maintaining lane.
## http://127.0.0.1:5000/deepqtest/lgsvl-api/agents/npc-vehicle/cross-road?car=SUV&color=red&maintainlane=1&position=near
## A black SchoolBus is crossing the road (near) and maintaining lane.
...
## A black SchoolBus is overtaking (near) the ego vehicle and maintaining lane.
...
## A skyblue BoxTruck is driving ahead (near) of the ego vehicle and switching lane.
...
## A red BoxTruck is overtaking (near) the ego vehicle and maintaining lane.
...
## A black Sedan is driving ahead (near) of the ego vehicle and maintaining lane.
...
## A black Jeep is driving ahead (near) of the ego vehicle and switching lane.
...
## A black Jeep is overtaking (near) the ego vehicle and maintaining lane.
...
## A skyblue Sedan is driving ahead (near) of the ego vehicle and switching lane.
...
## A pink SchoolBus is crossing the road (near) and switching lane.
...
## A black SUV is crossing the road (near) and switching lane.
...
## A red Hatchback is driving from the opposite direction (near) and switching lane.
...
## A yellow Hatchback is driving ahead (near) of the ego vehicle and maintaining lane.
...
## A yellow SUV is overtaking (near) the ego vehicle and switching lane.
...
## A pink Hatchback is driving ahead (near) of the ego vehicle and switching lane.
...
## A black SchoolBus is driving ahead (near) of the ego vehicle and maintaining lane.
...
## A black Hatchback is overtaking (near) the ego vehicle and switching lane.
...
## A yellow SchoolBus is driving from the opposite direction (near) and switching lane.
...
## A yellow Hatchback is overtaking (near) the ego vehicle and maintaining lane.
...
## A pink BoxTruck is driving ahead (near) of the ego vehicle and maintaining lane.
...
## A black SUV is driving ahead (near) of the ego vehicle and maintaining lane.
...
## A pink BoxTruck is crossing the road (near) and switching lane.
...
## A pink Jeep is crossing the road (near) and switching lane.
...
## A white BoxTruck is overtaking (near) the ego vehicle and switching lane.
...
## A red Sedan is overtaking (near) the ego vehicle and maintaining lane.
...
## A white SchoolBus is driving ahead (near) of the ego vehicle and switching lane.
...
## A red SUV is driving ahead (near) of the ego vehicle and switching lane.
...
## A red Hatchback is crossing the road (near) and switching lane.
...
## A red BoxTruck is driving from the opposite direction (near) and maintaining lane.
...
## A yellow Sedan is overtaking (near) the ego vehicle and switching lane.
...
## A pink Sedan is driving from the opposite direction (near) and maintaining lane.
...
## A red SchoolBus is overtaking (near) the ego vehicle and switching lane.
...
## A red SchoolBus is driving from the opposite direction (near) and maintaining lane.
...
## A yellow Sedan is driving from the opposite direction (near) and switching lane.
...
## A red Jeep is overtaking (near) the ego vehicle and switching lane.
...
## A yellow SUV is driving from the opposite direction (near) and switching lane.
...
## A skyblue SUV is driving from the opposite direction (near) and maintaining lane.
...
## A yellow Hatchback is crossing the road (near) and maintaining lane.
